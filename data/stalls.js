  ...
  const STALLS = [
    {
      ...
      gerobakTransform: { scale: 0.92, rotateDeg: -6 }
    },
    {
      label: "Favorit Lebaran",
      title: "Booth Kue Kering-pastry-cake",
      ...
      gerobakTransform: { scale: 0.95, rotateDeg: 5 }
    },
        {
      label: "Kerinduan bersama",
      title: "Booth Jajanan dan panganan Nusantara",
      subtitle: "Berbagai jenis jajanan khas nusantara, pengobat rindu di hari raya",
      description:
        "Tawarkan berbagai jajanan khas dari berbagai daerah di Indonesia, obati kerinduan diaspora indonesia dengan jajanan khas daerah",
      background: "assets/bg-stall-7.jpg",
      accents: ["#0b4f6c", "#ffd166", "#f566b4"],
      gerobakTransform: { scale: 0.95, rotateDeg: 5 }
    },
    {
      ...
      gerobakTransform: { scale: 1.02, rotateDeg: -3 }
    },
    {
      ...
      gerobakTransform: { scale: 1.0, rotateDeg: 4 }
    },
    {
      label: "Produk Lokal",
      ...
      gerobakTransform: { scale: 0.98, rotateDeg: -4 }
    },
    {
      label: "Zona Keluarga",
      ...
      gerobakTransform: { scale: 1.05, rotateDeg: 6 }
    }
  ];
